  ...
  return (
    <div className='Dashboard_maindiv'>
        <div className='admindashmain '>
            ...
            <div className="card text-white patient_history mb-3 admincard col ml-2" onClick={clickPatientdetails}>
                <div className='card_img_div'>
                    <img className="card-img adminimgone" src={admincardoneimg} alt="Card image" ></img>
                </div>                 
                <div className="card-img-overlay "  style={{zIndex:1}}>
            ...
            <div className="card text-white lab_summary mb-3 admincard col ml-2" onClick={clicklabdetails}>
                <div className='card_img_div'>
            ...
            <div className="card text-white  mb-3 admincard col-4 ml-2 blood_bank " style={{backgroundColor:'rgb(243 3 3)'}} onClick={()=>{navigate('requestdonation')}}>
                    <div className='card_img_div'>
            ...
            <div className='row'>
                 <div className="card text-white remote_monitoring mb-3 admincard ml-2 col-4"  >
                    <div className='card_img_div'>
                        ...
                        {/* <div className='admincard_round1' style={{backgroundColor:'#376591'}}></div>
                        <div className='admincard_round2' style={{backgroundColor:'#3d7fa5'}}></div> */}
                </div>
                {/* onclick in pharma data card onClick={clickconsultpatients} */}
                <div className="card text-white  mb-3 admincard col ml-2 remote_monitoring" >
                    ...
                    <div class="card-img-overlay">
                        <h4 className="admincardhead">Pharmacy Data</h4>
                    </div>
