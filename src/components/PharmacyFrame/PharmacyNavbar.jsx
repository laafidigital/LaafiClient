...
const PharmacyNavbar = () => {
  ...
  const homeIndex = pathname.indexOf('/pharmacyhome/');
  const idParam = homeIndex !== -1 ? pathname.substring(homeIndex + 14) : undefined;
    ...
    <Box sx={{ flexGrow: 1 }}>
      ...
      <TransparentDrawer anchor="left" open={DrawerOpen} onClose={closedDrawer} variant='permanent'>
        <div className='Drawer'>
          ...
          <List>
          <ListItem button onClick={()=>{navigate('pharmacydashboard');closedDrawer()}} className='listitem '>
